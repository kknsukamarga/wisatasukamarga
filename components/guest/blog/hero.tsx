  ...
  return (
    ...
    >
      <div className="flex justify-center items-center flex-col z-40">
        <motion.p
          style={{ y: textY }}
          className={`font-bold text-gray text-lg relative z-40 ${Questa.className}`}
        >
          Artikel Berita Seputar Wisata & UMKM
        </motion.p>

        <motion.h1
          style={{ y: textY }}
          className={`font-bold text-gray text-7xl md:text-9xl relative z-40 ${Questa.className}`}
        >
          Suka Marga
        </motion.h1>
      </div>
