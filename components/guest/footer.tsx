...
{/*           <p className="text-muted-foreground md:max-w-[60%]">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-16">
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-4">
              <h4 className="text-sm font-bold">Link Desa Suka Marga</h4>

              <div className="flex gap-4 h-fit">
                <Link
                  href="https://www.instagram.com/sukamarga.suoh/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white p-2 bg-green rounded-full"
                >
                ...
                <Link
                  href="https://www.tiktok.com/@sukamarga.suoh"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white p-2 bg-green rounded-full"
                >
      ...
      <div className="mt-8 border-gray pt-4 text-center text-xs text-muted-foreground md:mt-12 md:pt-6">
        <p>
          &copy; 2024 KKN Tematik Desa Suka Marga ITERA. <br /> All rights
          reserved.
        </p>
      </div>
    </footer>
