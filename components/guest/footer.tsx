  ...
  return (
    <footer className="bg-white py-8 md:py-12">
      <div className="container mx-auto grid grid-cols-1 gap-8 px-4 sm:grid-cols-2 md:grid-cols-4 md:px-6 lg:max-w-7xl">
        ...
        <div className="grid gap-2">
          <h4 className="text-sm font-semibold">Found us on</h4>
      ...
      <div className="mt-8 border-t border-gray pt-4 text-center text-xs text-muted-foreground md:mt-12 md:pt-6">
        <p>
