...
export default function ProductDetail({ params }: { params: { "nama-umkm": string } }) {
  ...
  onClick={() => window.open(`https://wa.me/${productData.wanumber}?text=Halo,%20saya%20ingin%20membeli%20produk%20${encodeURIComponent(productData.description)}.`, '_blank')}
>
  Beli Produk
</button>
        ...
        <div className="bg-orange-500 p-4 mt-8 rounded-lg">
          <h2 className="text-xl font-bold text-gray mb-4">Lihat Produk Lainnya...</h2>
